...
def main():
    ...
    protocol = {
        ...
        "rsc_objective": "event-average estimating equation; auxiliary normalized common Gaussian likelihood",
        "bootstrap_policy": "production fixed attempts with failure abort; reference null uses fixed attempts and failure bounds",
