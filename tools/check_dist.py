    ...
    required_sdist.update(
        {
            ...
            "/examples/branch_gaussian/README.md",
            "/examples/branch_gaussian/tree.nwk",
            "/examples/branch_gaussian/traits.tsv",
            "/examples/branch_gaussian/branch_models.tsv",
            "/examples/branch_gaussian/branch_regimes.tsv",
            "/examples/branch_gaussian/regime_models.tsv",
            "/examples/branch_gaussian/fit/README.md",
            "/examples/branch_gaussian/fit/render.py",
            "/examples/branch_gaussian/fit/fit.tsv",
            "/examples/branch_gaussian/fit/tree.nwk",
            "/examples/branch_gaussian/fit/traits.tsv",
            "/examples/branch_gaussian/fit/branch_regimes.tsv",
            "/examples/branch_gaussian/fit/regime_models.tsv",
            "/examples/branch_gaussian/fit/output/fitted.png",
            "/examples/branch_gaussian/plot/README.md",
            "/examples/branch_gaussian/plot/render.py",
            "/examples/branch_gaussian/plot/tree.nwk",
            "/examples/branch_gaussian/plot/traits.tsv",
            "/examples/branch_gaussian/plot/branch_regimes.tsv",
            "/examples/branch_gaussian/plot/regime_models.tsv",
            "/examples/branch_gaussian/plot/output/posterior.png",
            "/examples/branch_gaussian/plot/output/prior.png",
            "/docs/guides/DTT.md",
            ...
            "/docs/guides/ASR.md",
            "/docs/guides/ASR_INDIVIDUALS.md",
            "/docs/guides/STOCHASTIC_MAPS.md",
            "/examples/stochastic_maps/README.md",
            "/examples/stochastic_maps/tree.nwk",
            "/examples/stochastic_maps/traits.tsv",
            "/examples/stochastic_maps/probabilities.png",
            "/examples/individual_asr/README.md",
            "/examples/individual_asr/tree.nwk",
            "/examples/individual_asr/individuals.tsv",
            "/examples/individual_asr/reference.R",
            "/docs/guides/SHIFT.md",
            "/docs/guides/NATIVE_SHIFT.md",
            "/docs/validation/NATIVE_SHIFT_VALIDATION.md",
            "/docs/validation/NATIVE_SHIFT_SCALING.md",
            ...
            "/docs/validation/SHIFT_VALIDATION.md",
            "/docs/validation/SHIFT_JOINT.md",
            "/docs/validation/SHIFT_PBIC.md",
            "/docs/validation/SHIFT_ALPHA.md",
            "/docs/validation/SHIFT_CALIBRATION.md",
            "/docs/validation/SHIFT_RESPONSE_VALIDATION.md",
            "/docs/validation/SHIFT_CALIBRATION_DECISION.md",
            "/reviews/shift-calibration-final-protocol.md",
            "/tools/shift_confidence_calibration.py",
            "/tools/verify_shift_confidence_calibration.py",
            "/tools/shift_continuous_reference.py",
            "/tools/verify_shift_null_contract.py",
            "/examples/shift/confidence-development/audit.json",
            "/examples/shift/confidence-development/records.jsonl.gz",
            "/examples/shift/null-contract-validation/records.jsonl.gz",
            "/examples/shift/null-contract-b999/records.jsonl.gz",
            "/reviews/shift-calibration-review.md",
            "/tools/shift_calibration_audit.py",
            "/tools/diagnose_shift_known_error.py",
            "/tools/verify_shift_known_error.py",
            "/tools/shift_known_error_envelope.py",
            "/tools/shift_variance_tail.py",
            "/examples/shift/known-error-diagnostic/protocol.json",
            "/examples/shift/known-error-diagnostic/summary.json",
            "/examples/shift/known-error-diagnostic/audit.json",
            "/examples/shift/known-error-diagnostic/records.jsonl.gz",
            ...
            "/docs/guides/SIGNAL.md",
            "/docs/guides/PCA.md",
            "/examples/pca/README.md",
            "/examples/pca/tree.nwk",
            "/examples/pca/traits.tsv",
            "/examples/pca/morphospace.png",
            "/examples/signal/tree.nwk",
            "/examples/signal/traits.tsv",
            "/examples/signal/README.md",
            "/examples/shift/tree.nwk",
            "/examples/shift/traits.tsv",
            "/examples/shift/traits-with-se.tsv",
            "/docs/guides/THRESHOLD_DIAGNOSTICS.md",
            "/examples/threshold/README.md",
            "/examples/threshold/diagnostic-pilot.json",
            "/examples/threshold/diagnostic-pilot-longer.json",
            "/tests/data/threshold_diagnostics.json",
            "/tests/data/threshold_diagnostic_draws.npz",
            "/tests/threshold_posterior_support.py",
            "/tools/validate_threshold_asr.py",
            "/tools/validate_threshold_diagnostics.py",
            "/docs/guides/RADTE.md",
            "/docs/guides/IQTREE_LIBRARY.md",
            "/docs/guides/RADTE_MATH.md",
            "/docs/validation/RADTE_VALIDATION.md",
            "/examples/radte/gene.nwk",
            "/examples/radte/species.nwk",
            "/examples/radte/species-map.tsv",
            "/examples/radte/README.md",
            "/docs/validation/ASR_PERFORMANCE.md",
            "/CHANGELOG.md",
            "/docs/guides/CLI_TSV_CONVENTIONS.md",
            "/DEVELOPMENT.md",
            "/docs/guides/PHYLOGENETIC_REGRESSION.md",
            "/docs/validation/REGRESSION_CALIBRATION.md",
            "/examples/regression_calibration/README.md",
            "/tools/validate_regression_calibration.py",
            "/tests/test_regression_calibration.py",
            "/docs/guides/REGRESSION_SELECTION.md",
            ...
            "/docs/guides/RECONCILED_SPECIATION_CONTRAST_MATH.md",
            "/RELEASING.md",
            "/constraints-dev.txt",
