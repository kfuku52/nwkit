...
layout=ShiftLayout.build(data.tree,[16,17,20,23,25,27])
print(f._general_fit(data,layout,NativeFitOptions(trait_covariance='full',alpha_model='shared',estimate_measurement_error=True),None,None,np.zeros(2),f.JointFitContext(data,'OUfixedRoot')))
